  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'fade-in-down2': 'fade-in-down 3.5s ease-out'
      },
      colors: {
        gray: {
          100: '#FBFBFB',
      ...
      backgroundImage: function backgroundImage(_ref) {
        ...
        return {
          'vc-border-gradient': "radial-gradient(at left top, ".concat(theme('colors.gray.500'), ", 50px, ").concat(theme('colors.gray.800'), " 50%)")
        };
      },
      spacing: {
        '9/16': '56.25%',
