...
var page = function () {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement(Container_1["default"], null,
            react_1["default"].createElement(Heading_1["default"], { title: "Fans", center: true, subtitle: "Fans for every commercial, industrial and institutional application." }),
            react_1["default"].createElement("div", { className: "max-w-xl py-7 mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-center md:max-w-2xl lg:max-w-none justify-center" }, items.map(function (item) { return (react_1["default"].createElement("div", { key: item.title, className: " dark:bg-gray-800 dark:border-gray-700 bg-gradient-to-r from-[#67f936] to-[#4f60f2] space-y-4 relative flex flex-col items-center p-2 bg-white rounded shadow-2xl " },
                react_1["default"].createElement("div", { className: " bg-white shadow-md item1 px-3 py-4 border-2 w-auto h-auto flex flex-col items-center justify-center rounded-lg space-y-3" },
