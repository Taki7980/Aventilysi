                        ...
                        <div className="py-3 md:py-5 lg:py-8 w-full md:w-full lg:w-full px-1 md:px-1 lg:px-1">
                              ...
                              <div className="text-center pb-12 md:pb-16 w-full">
                                    <div className="w-full flex flex-col justify-center items-center md:flex-row lg:flex-row mb-4 space-y-1 lg:space-y-0 md:space-y-0 space-x-3" data-aos="zoom-y-out">
                                          ...
                                          <h1 className="lg:text-4xl md:text-3xl text-[24px] drop-shadow-lg font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-blue-700 to-green-700">{title.slice(18,)}</h1>
                                    </div>
                                    <div className="w-full lg:w-full md:w-full mx-auto px-1">
                                          <p className=" drop-shadow-lg lg:text-xl md:text-base sm:text-sm text-[15px] font-thin text-gray-600 pb-8" data-aos="zoom-y-out" data-aos-delay="150">{subtitle}</p>
