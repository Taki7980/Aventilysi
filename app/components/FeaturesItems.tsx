...
const FeaturesItems = () => {
      return (
            <div>
                  <div className="grid lg:w-3/5 md:w-1/2 w-auto grid-cols-2 gap-8 mx-auto pb-10">


                        <div className="animate-fade-out-down1 p-2 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 bg-gradient-to-r from-[#D8B4FE] to-[#818CF8]">
                        ...
                        <div className="animate-fade-out-down2 p-2 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 bg-gradient-to-r from-[#D8B4FE] to-[#818CF8]">
                              <div className=" bg-white shadow-md item1 px-3 py-4 border-2 w-auto h-auto flex flex-col items-center justify-center rounded-lg space-y-3">
                        ...
                        <div className="animate-fade-out-down3 p-2 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 bg-gradient-to-r from-[#D8B4FE] to-[#818CF8]">
                              <div className=" bg-white shadow-md item1 px-3 py-4 border-2 w-auto h-auto flex flex-col items-center justify-center rounded-lg space-y-3">
                        ...
                        <div className="animate-fade-out-down4 p-2 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 bg-gradient-to-r from-[#D8B4FE] to-[#818CF8]">
                              <div className=" bg-white shadow-md item1 px-3 py-4 border-2 w-auto h-auto flex flex-col items-center justify-center rounded-lg space-y-3">
