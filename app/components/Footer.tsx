      ...
      return (
            <footer>
                  <div className="max-w-6xl h-auto mx-auto px-4 sm:px-6 py-7">
                        ...
                        {/* Bottom area */}
                        <div className="lg:flex lg:items-center lg:justify-between lg:flex-row md:flex-row sm:flex-col sm:items-center sm:justify-between py-8">
                              ...
                              <div className="flex mb-4 md:order-1 md:ml-4 md:mb-0 text-2xl">
                                    ...
                                    <div className="ml-4">
                                          <Link href="https://www.linkedin.com/company/greenheck/" target="_blank" className="h-8 w-8 flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="LinkedIn">
                                                <BsLinkedin height={80} width={80}  />
                                          </Link>
                                    </div>
                                    <div className="ml-4">
                                          <Link href="https://www.facebook.com/greenheckhvac" target="_blank" className="h-8 w-8 flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
                              ...
                              {/* Copyrights note */}
                              <div className="text-xl text-gray-600 mr-4">©2023 Greenheck Fan Corporation. All Rights Reserved.</div>
